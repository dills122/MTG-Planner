    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            silo = new SiloHostBuilder()
                ...
                {
                    options.ClusterId = "mtg-planner-deployment1";
                    options.ServiceId = "MtgPlannerApp";
                })
                ...
                .ConfigureApplicationParts(parts => parts.AddApplicationPart(typeof(AppGrain).Assembly).WithReferences())
